            ...
            if (messageType == CometChatConstants.MESSAGE_TYPE_TEXT) {
                ...
                try {
                    ...
                    for (i in 0 until options.length()) {
                        ...
                        textViewOption.setTextAppearance(this, com.cometchat.pro.R.style.TextAppearance_AppCompat)
                        textViewPercentage.setTextAppearance(this, com.cometchat.pro.R.style.TextAppearance_AppCompat)
